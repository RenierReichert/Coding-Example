...
static const float3x3 ORIENT_POS_X = float3x3( 1, 0, 0, 0,  1, 0, 0, 0, 1);
...
static const float2 OFFSET_POS_X = float2(0.66666666,  0.0);
static const float2 OFFSET_NEG_X = float2(0.0, 0.0);
static const float2 OFFSET_POS_Y = float2(0.66666666, 0.5);
static const float2 OFFSET_NEG_Y = float2(0.0, 0.5       );
static const float2 OFFSET_POS_Z = float2(0.33333333,  0.0       );
static const float2 OFFSET_NEG_Z = float2(0.33333333,  0.5);
